...
def main():
    ...
    request = create_request(parsed_url, args.request_method, headers, args.request_payload)
...
def create_args_parser() -> argparse.ArgumentParser:
    ...
    parser.add_argument(
        '-d', dest='request_payload', type=str,
        help='Payload to be sent with the request')
    parser.add_argument('-H', dest='request_header',
                        type=str, help='Header to be sent with the request')
    return parser
...
def create_request(parsed_url: dict, request_method: str, headers: list[str], request_payload: str) -> str:
    '''
